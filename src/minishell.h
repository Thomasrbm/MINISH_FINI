...
/*   Updated: 2025/02/24 12:46:53 by throbert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							process_directory(char *base_path,
									char *pattern, t_list **lst,
									int is_recursive);
...
int								recursive_match(char *pattern, char *name);
int								handle_bracket(char *pattern, char *str,
									t_wildcard *wc);
int								handle_char_match(char *patt, char *str, int *p,
									int *s);
